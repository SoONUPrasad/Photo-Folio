        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {album ? (
            ...
            <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-2">
              ...
              <div className="mt-2 lg:flex lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
                {albums.map((album) => (
                  <div key={album.id}>
                  <div
                    key={album.id}
                  ...
                  >
                    ...
                    <h3 className="font-bold text-center w-full bg-gray-200 cursor-pointer hover:bg-blue-500 hover:text-white">
                      <a href={album.href}>
